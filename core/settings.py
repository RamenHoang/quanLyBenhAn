...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'store_extra': 'main_app.templatetags.store_extra',
            }
        },
    },
]
...
# https://docs.djangoproject.com/en/5.0.6/ref/settings/#default-auto-field
